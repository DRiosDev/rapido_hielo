...
export const Unauthorized = "/login";
export const UNAUTHORIZED = "/unauthorized";

export const REQUESTRESETPASSWORD = "/recuperar-clave";
export const RESETPASSWORD = "/cambiar-clave/:token";

//privadas
export const PRIVATEUSERS = "/priv";
export const DASHBOARD = "/priv/panel-administrativo";
